...
class Wav2Vec2SERModel(L.LightningModule):
    LOCAL = "local"
    ...
    def __init__(
        ...
        # loaded in by the CLI
        self.stats = None

        # freeze the weights of the wav2vec model
        self.embedding = Wav2Vec2Model.from_pretrained(base_model_name)
        self.embedding_layers = 13
    ...
    def forward(self, x, mask, embedding=None):
        ...
        if self.hparams.speaker_norm:
            ...
            output_state = x.last_hidden_state
        else:
